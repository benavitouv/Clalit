...
Hebrew UI for submitting loan applications. The server accepts the form, uploads the attachment, and calls the webhook with the `Process this loan application` message and the attachment id.
